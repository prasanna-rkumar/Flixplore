...
const RightPane = () => {
  ...
  return (
    <div className={`custom-scroll col-span-6 col-start-1 absolute top-0 left-0 flex flex-col gap-2 justify-start items-start mx-auto w-full bg-primary z-20 overflow-y-scroll lg:col-span-2 lg:col-start-5 lg:col-end-7 lg:sticky lg:h-3/4 lg:max-w-lg ${detailsVisibility}`} style={{ top: '12.5%', height: '80vh' }}>
